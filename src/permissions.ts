...
class PermissionManager {
	...
	private permissions: CollectionManager<string, PermissionEntry>;
	...
	public async init() {
		this.permissions = await this.framework.database.collection<string, PermissionEntry>("permissions-new", false, "name");
