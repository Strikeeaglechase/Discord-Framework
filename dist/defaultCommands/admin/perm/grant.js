...
class PermGrant extends Command {
    ...
    run(event, permName, target) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield event.framework.utils.reactConfirm(`Are you sure you would like to grant the __${event.perm.name}__ permission to ${target.value.toString()}?`, event.message, {
                onConfirm: () => __awaiter(this, void 0, void 0, function* () {
                    assert(!Array.isArray(event.perm), `Perms cannot be an array`);
                    const ret = yield event.framework.permissions.grant(event.perm.name, target.id);
                    if (ret) {
