...
class PingData extends SlashCommand {
    ...
    async run(event, data, replyTwice, u) {
        let result = data;
        if (replyTwice)
            result += data;
        if (u) {
...
__decorate([
    __param(1, SArg()),
    __param(2, SArg()),
    __param(3, SArg({ name: "fuck", required: false })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [SlashCommandEvent, String, Boolean, Object]),
    __metadata("design:returntype", Promise)
], PingData.prototype, "run", null);
